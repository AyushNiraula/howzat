...
<div className="cursor-pointer">
  <nav className="flex flex-wrap gap-6 sm:flex-nowrap sm:gap-6" aria-label="Tabs">
...
{data?.rank?.map((player:any)=>{
    ...
    <>
      <tr>
          ...
          <td className="whitespace-nowrap px-4 py-2 font-semibold text-purple-700">{player?.name}</td>
