  ...
  <div className="inner p-4">
    <nav>
      <ul className="space-y-3 text-sm md:text-base">
        <li>
          <Link to="/" className="font-semibold hover:text-blue-400 transition-colors">
            Home
          </Link>
        </li>
        <li>
          <Link to="/match" className="font-semibold hover:text-blue-400 transition-colors">
            Match
          </Link>
        </li>
        <li>
          <Link to="/ranking" className="font-semibold hover:text-blue-400 transition-colors">
            Ranking
          </Link>
        </li>
        <li>
          <Link to="/stats" className="font-semibold hover:text-blue-400 transition-colors">
            Stats
          </Link>
        </li>
        <li>
          <Link to="/contact" className="font-semibold hover:text-blue-400 transition-colors">
            Contact
          </Link>
        </li>
      </ul>
