...
const MatchDetails = () => {
  ...
  useEffect(() => {
    setFilteredMatch(data?.typeMatches.find((match: any) => match?.matchType === matchType))
  }, [matchType, data])
  ...
  return (
    <>
      <div className="p-1 flex flex-wrap items-center justify-start">
        ...
        {filteredMatch?.seriesMatches && filteredMatch?.seriesMatches.map((seriesMatch: any) => {
          return (
            <div onClick={() => handleMatchCardClick(seriesMatch?.seriesAdWrapper?.seriesId)}
            ...
            >
              ...
              <div className="relative text-white px-6 pb-6 mt-6">
                ...
                <div className="flex justify-between">
                  <span className="block font-semibold text-sm">{seriesMatch?.seriesAdWrapper?.seriesId}</span><br /><br />
